...
If you already have a Next.js project, you don&apos;t need to create a new app from scratch. Instead, the CLI will follow these steps to migrate your project to Zap.ts:
