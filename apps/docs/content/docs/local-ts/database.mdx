---
title: Database
description: SQLite database with Diesel ORM, automatic migrations, and a layered architecture in Local.ts.
---
...
<Callout type="info" title="Connection Pool">
...
<Callout type="warn">
  If you don't register your commands with Tauri using `invoke_handler`, your frontend won't be able
  to call them. Always ensure new commands are added here.
</Callout>
