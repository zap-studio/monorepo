...
description: Customize the sidebar navigation links and structure in your Local.ts app.
---
...
<Callout type="info">
  The sidebar is just a React component. You're free to completely rewrite it or use a different
  navigation pattern if needed.
</Callout>
...
export const SIDEBAR_TOP_ITEMS: SidebarItem[] = [
  { icon: Home, label: "Home", href: "/" },
  // { icon: Users, label: "Team", href: "/team" }, // removed
];
```
