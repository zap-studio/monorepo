...
2. **Generate icons**
   ...
   ```bash
   vp exec tauri icon path/to/your-icon.png
   ```
...
<Callout type="info">
  The icon generator automatically creates all necessary sizes and formats. You only need to provide
  one high-quality source image.
</Callout>
