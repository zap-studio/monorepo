...
| **Cargo Tauri CI** | [tauri-ci.yml](https://github.com/zap-studio/local.ts/blob/main/.github/workflows/tauri-ci.yml)       | Runs `cargo check`, `cargo test`, and a debug Tauri build |
