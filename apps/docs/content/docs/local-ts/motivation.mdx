...
- **Vite+** — Unified installs, checks, test runs, and cached app workflows
- **Vite Task** — Lightweight task orchestration for routes, builds, and validation
- **Vitest-compatible testing** — Fast test runs with coverage support
- **Staged fixes** — Automatic `vp check --fix` for staged frontend files
...
Ready to build your first local-first desktop app? Check out the [Getting Started guide](/docs/local-ts/getting-started) to create your first Local.ts app in minutes.
