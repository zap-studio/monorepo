...
### Root & Public
<FileListRenderer list={RootFiles} />

#### Metadata
<FileListRenderer list={MetadataFiles} />

#### Error Handling
<FileListRenderer list={ErrorFiles} />

#### IDE-Specific Files
<FileListRenderer list={IdeFiles} />

#### Docker Files
<FileListRenderer list={DockerFiles} />

### Configurations
<FileListRenderer list={ConfigFiles} />

### Pages
<FileListRenderer list={PagesFiles} />

### Routes
<FileListRenderer list={RoutesFiles} />

### Components
<FileListRenderer list={ComponentsFiles} />

### Hooks
<FileListRenderer list={HooksFiles} />

### Libraries
<FileListRenderer list={LibrariesFiles} />

### Emails
<FileListRenderer list={EmailsFiles} />

### Middleware
<FileListRenderer list={MiddlewareFiles} />

### Providers
<FileListRenderer list={ProvidersFiles} />

### Instrumentation
<FileListRenderer list={InstrumentationFiles} />

### Zap.ts Specific
<FileListRenderer list={ZapFiles} />