...
<FileList>
<FileEntry name="src/app/apple-icon.png" status="added">
...
<FileEntry name="src/app/fonts.ts" status="added" required>
Configuration file for [Geist](https://vercel.com/font) font to be used in the application.
</FileEntry>

<FileEntry name="src/app/icon.png" status="added">
...
<FileEntry name="src/app/opengraph-image/route.tsx" status="added">
...
<FileEntry name="src/app/manifest.ts" status="added" plugins={['pwa']}>
...
<FileList>
<FileEntry name="src/app/global-error.tsx" status="added">
Global error handling component for the application with a sophisticated error messages management.
</FileEntry>

<FileEntry name="src/app/not-found.tsx" status="added">
...
<FileList>
<FileEntry name=".cursor/" status="added" ide={"cursor"} folder>
...
<FileEntry name=".cursorignore" status="added" ide={"cursor"}>
Similar to `.gitignore`, this file specifies which files and directories should be ignored by [Cursor](https://cursor.com/).
</FileEntry>

<FileEntry name=".github/copilot-instructions.md" status="added" ide={"vscode"}>
...
<FileEntry name=".vscode/" status="added" ide={"vscode"} folder>
...
<FileEntry name=".windsurf/" status="added" ide={"windsurf"} folder>
...
<FileEntry name="Dockerfile.prod" status="added">
...
<FileEntry name="compose.yml" status="added">
...
<FileList>
  ...
  <FileEntry name=".gitignore" status="modified" required>
...
<FileList>
<FileEntry name="src/app/api/auth/[...all]/route.ts" plugins={['auth']} status="added">
Authentication API route for handling all auth-related requests with [Better Auth](https://better-auth.com).
</FileEntry>

<FileEntry name="src/app/rpc/[[...rest]]/route.ts" plugins={['api']} status="added">
...
<FileList>
<FileEntry name="src/components/ui/" status="added" folder required>
...
<FileList>
<FileEntry name="src/hooks/use-mobile.ts" status="added" required>
...
<FileEntry name="src/hooks/utils/use-body-scroll-lock.ts" status="added" plugins={['components']}>
Custom hook for managing body scroll locking in modals and other components.
</FileEntry>

<FileEntry name="src/hooks/utils/use-cooldown.ts" status="added" plugins={['auth']}>
...
<FileList>
<FileEntry name="src/lib/fetch.ts" status="added" plugins={['auth']}>
...
<FileEntry name="src/lib/plugins.ts" status="added" required>
Plugin management library for handling Zap.ts plugins.
</FileEntry>

<FileEntry name="src/lib/utils.ts" status="added" required>
...
<FileList>
<FileEntry name="emails/" status="added" plugins={['mails']} folder>
...
<FileList>
<FileEntry name="src/middleware.ts" status="added" plugins={['auth', 'blog', 'waitlist']}>
...
<FileList>
<FileEntry name="src/providers/providers.tsx" status="added" required>
...
<FileEntry name="src/providers/theme.provider.tsx" status="added" required>
...
<FileList>
<FileEntry name="src/instrumentation.edge.ts" status="added" required>
Instrumentation for the Edge runtime environment.
</FileEntry>

<FileEntry name="src/instrumentation.node.ts" status="added" required>
Instrumentation for the Node.js runtime environment.
</FileEntry>

<FileEntry name="src/instrumentation.ts" status="added" required>
...
<FileList>
<FileEntry name="zap.config.ts" status="added" required>
Configuration files for Zap.ts.
</FileEntry>

<FileEntry name="zap.config.types.ts" status="added" required>
Type definitions for Zap.ts configuration.
</FileEntry>

<FileEntry name="zap/" status="added" required folder>
