...
Your framework layer should convert incoming requests into `NormalizedRequest` and call:
...
If you need reusable framework integration, see [Adapters](/docs/packages/webhooks/adapters).
