---
title: Overview
description: A type-safe, declarative authorization library with Standard Schema support and composable conditions.
---
...
`permit` solves this by letting you define all your authorization rules in one place, with full type safety and composable building blocks.
