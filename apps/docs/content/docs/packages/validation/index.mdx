---
title: Overview
description: Standard Schema utilities and ValidationError helpers shared across Zap Studio packages.
---
...
`validation` provides exactly that, and is used internally by `fetch` and other Zap Studio runtime packages.
