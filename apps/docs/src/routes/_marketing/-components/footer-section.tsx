...
const FooterLinkItem = ({ href, label, external }: FooterLink): ReactNode => {
  if (external === true) {
    return (
      <li>
        <a
...
const FooterColumnGroup = ({ heading, links }: FooterColumn): ReactNode => (
  <div>
...
export const FooterSection = (): ReactNode => (
      ...
      <FadeIn delay={0.1} duration={0.4} y={8}>
        ...
        >
          <div className="flex flex-col items-center gap-1 sm:items-start">
            ...
            >
              &copy; {new Date().getFullYear()} alexandretrotel.
            </p>
          </div>
