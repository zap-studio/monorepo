...
export const HeroSection = (): ReactNode => (
  <section className="relative flex min-h-[calc(100svh-3.5rem)] flex-col overflow-hidden border-b border-fd-border">
    ...
    <div className="relative mx-auto flex w-full max-w-4xl flex-1 flex-col items-center justify-center px-6 py-16 text-center sm:py-24 md:py-40">
      ...
      <FadeIn delay={0.15} duration={0.6} y={16}>
        <p className="mx-auto mt-4 max-w-xl text-sm leading-6 text-fd-muted-foreground sm:mt-6 sm:text-base sm:leading-7 md:mt-8 md:text-xl md:leading-8">
