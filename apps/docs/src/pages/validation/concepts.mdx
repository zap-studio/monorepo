...
:::info[Note] Standard Schema is a shared initiative across major validation libraries and ecosystem maintainers, including libraries like [Zod](https://zod.dev/), [Valibot](https://valibot.dev/), and [ArkType](https://arktype.io/). :::
