...
If you are new to schema validation, read [Concepts](/validation/concepts) first.
...
:::info[Tip] Prefer the async helper (`standardValidate`) by default. It is the most compatible option because it supports both sync and async schemas. :::
