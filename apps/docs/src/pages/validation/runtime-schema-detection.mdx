...
Runtime schema detection via `isStandardSchema` — a type guard that checks whether a value implements the [Standard Schema](https://standardschema.dev) interface.
...
- [Types](/validation/types) — `StandardSchemaV1`
