...
- [Verification](/webhooks/verification) — reject forged requests before they reach your handlers
- [Lifecycle Hooks](/webhooks/lifecycle-hooks) — add logging, metrics, and error handling
- [Adapters](/webhooks/adapters) — build a reusable framework integration with `BaseAdapter`
- [Guides](/webhooks/guides) — complete GitHub and Stripe examples
