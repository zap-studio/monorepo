import type { EventMessage, EventSchemaMap, RawEventMessage } from "../types";
 ...
 */
export type Subscriber<TSchemas extends EventSchemaMap> = {
  /**
   ...
   */
  filter?: (event: EventMessage<TSchemas> | RawEventMessage) => boolean;
