...
describe(constantTimeEquals, () => {
  ...
  describe("constant-time behavior", () => {
    it("should process strings of equal length in similar time", () => {
      ...
      expect(constantTimeEquals(str1, str2a)).toBeTruthy();
      expect(constantTimeEquals(str1, str2b)).toBeFalsy();
      expect(constantTimeEquals(str1, str2c)).toBeFalsy();
    });
    ...
    it("should not short-circuit on first difference", () => {
      ...
      expect(constantTimeEquals(str1, str3)).toBeFalsy();
    });
  });
  ...
  describe("edge cases", () => {
    it("should handle strings with null bytes", () => {
      ...
      const str3 = "hello\u0000earth";

      expect(constantTimeEquals(str1, str2)).toBeTruthy();
      expect(constantTimeEquals(str1, str3)).toBeFalsy();
    });
  ...
  describe("security-relevant scenarios", () => {
    it("should correctly compare HMAC signatures", () => {
      ...
      expect(constantTimeEquals(validSig, sameSig)).toBeTruthy();
      expect(constantTimeEquals(validSig, invalidSig)).toBeFalsy();
    });
    ...
    it("should compare hex-encoded hashes correctly", () => {
      ...
      expect(constantTimeEquals(hash1, hash2)).toBeTruthy();
      expect(constantTimeEquals(hash1, hash3)).toBeFalsy();
    });
    ...
    it("should handle comparing API keys or tokens", () => {
      ...
      expect(constantTimeEquals(token1, token2)).toBeTruthy();
      expect(constantTimeEquals(token1, token3)).toBeFalsy();
    });
  });
