...
describe("Schema validation with Zod", () => {
  ...
  it("should transform data with Zod transforms", async () => {
    ...
    const response = await router.handle(createRequest("/webhooks/transform", { value: "hello" }));
...
describe("Path matching", () => {
  it("should route requests with query parameters", async () => {
    ...
    const response = await router.handle(createRequest("/webhooks/query?param=value&other=1", {}));
