...
export interface ZapSettings {
  ...
  SECURITY: {
    ...
    PERMISSIONS_POLICY: {
      ...
      BLUETOOTH: string[];
      CAMERA: string[];
      CAPTURED_SURFACE_CONTROL: string[];
      COMPUTE_PRESSURE: string[];
      CROSS_ORIGIN_ISOLATED: string[];
      DEFERRED_FETCH: string[];
      DEFERRED_FETCH_MINIMAL: string[];
      ...
      GYROSCOPE: string[];
      HID: string[];
      IDENTITY_CREDENTIALS_GET: string[];
      ...
      PUBLICKEY_CREDENTIALS_CREATE: string[];
